...
############################
#### Third model fit
# fit linear model using hight as outcome and color and age as the predictors

lmfit3<- lm(Height ~ `Eye Color` + Age, mydata)

#using the tidy function to create a table of the results of the model
lmtable3 <- broom::tidy(lmfit3)

#using print to view the table
print (lmtable3)

#saving the fit results table
